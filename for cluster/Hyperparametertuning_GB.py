...
kf = KFold(n_splits=5, shuffle=True, random_state=101)
grid_search_gb = RandomizedSearchCV(GradientBoostingRegressor(random_state=101), param_space, cv=kf, verbose=10,
                              scoring='neg_mean_absolute_error', n_iter=40)
grid_search_gb.fit(X_t, y_t)
results = {"best_params": grid_search_gb.best_params_, "best_score": grid_search_gb.best_score_,
